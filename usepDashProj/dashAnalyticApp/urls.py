...
urlpatterns = [
    ...
    path('dashboard-analytic/',views.anaDashboardView,name="anaDashboardView"),
    path('analytics/',views.analyticsView,name="analyticsView"),
    ...
    path('board-passers/',views.boardPassersView,name="boardPassersView"),
    ...
    path('employability/',views.employabilityView,name="employabilityView"),
    ...
    path('ched-rdc-identified/',views.chedRdcView,name="chedRdcView"),
    ...
    path('accreditation/',views.accredView,name="accredView"),
    ...
    path('faculty-research/',views.gradResView,name="gradResView"),
    ...
    path('research-degree/',views.resDegView,name="resDegView"),
    ...
    path('accredited-grad-programs/',views.accrGradProgView,name="accrGradProgView"),
    ...
    path('research-output/',views.resOutputView,name="resOutputView"),
    ...
    path('research-complete/',views.resCompleteView,name="resCompleteView"),
    ...
    path('research-published/',views.resPublishedView,name="resPublishedView"),
    ...
    path('active-partner/',views.actPartnerView,name="actPartnerView"),
    ...
    path('trainees/',views.traineesView,name="traineesView"),
    ...
    path('extension-program/',views.extProgramView,name="extProgramView"),
    ...
    path('beneficiary/',views.beneficiaryView,name="beneficiaryView"),
